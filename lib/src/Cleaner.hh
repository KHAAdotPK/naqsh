...
#ifndef CSV_PARSER_LIB_CLEANER_HH
#define CSV_PARSER_LIB_CLEANER_HH
...
void Cleaner::appendCodePoint(std::string& result, char32_t cp)
{
...
std::string Cleaner::cleanLine(const std::string& line)
{
    bool skip = false;
    ...
    while (i < line.size())
    {
        ...
        /* Following block of code is for documentation purposes */
        /**********************************************************************************
        ...
        /*
            if (validUTF8Sequence)
            {
                ...
                {                
                    ...
                    result += ' '; // The delimeter will be skipped and not appended to the cleaned text. 
                                   // Here we are replacing the delimeter with white-space.            
                }
            }
         */                            
        /***********************************************************************************
 ...
 */
std::string Cleaner::collapseSpace(const std::string& result) 
{
    /*
 ...
 */
bool Cleaner::isAlpha(char32_t cp)
{
 ...
 */
bool Cleaner::isDigit(char32_t cp)
{
...
*/
bool Cleaner::isDot(char32_t cp)
{
 ...
 */
bool Cleaner::isTokenDelimiter(char32_t cp)
{
 ...
 */
bool Cleaner::isUrduLetter(char32_t cp)
{
    // ============================================================
 ...
 */
char32_t Cleaner::normalize(char32_t cp)
{
    switch (cp)
    {
        /*
